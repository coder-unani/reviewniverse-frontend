      ...
      r(r.S, "Math", {
        hypot: function (t, n) {
          for (var e, r, o = 0, u = 0, c = arguments.length, a = 0; u < c; )
            (e = i(arguments[u++])),
              a < e ? ((r = a / e), (o = o * r * r + 1), (a = e)) : e > 0 ? ((r = e / a), (o += r * r)) : (o += e);
        ...
        "Number",
        {
          toFixed: function (t) {
            ...
            return (
              f > 0
                ? ((c = y.length),
                  (y = g + (c <= f ? "0." + u.call("0", f - c) + y : y.slice(0, c - f) + "." + y.slice(c - f))))
                : (y = g + y),
              y
            );
          },
      ...
      if (
        ...
        f = function (t, n) {
          ...
          return !e && r && t.constructor === f && o
            ? t
            : i(
                d ? new s(r && !o ? t.source : t, n) : s((r = t instanceof f) ? t.source : t, r && o ? a.call(t) : n),
                e ? this : l,
                f
              );
        };
          ...
          (v =
            ...
            "".split(/.?/)[p]
              ? function (t, n) {
                  ...
                  return (
                    l === i[p] ? (!c && v.test("")) || a.push("") : a.push(i.slice(l)), a[p] > d ? a.slice(0, d) : a
                  );
                }
    ...
    function (t, n, e) {
      ...
      var r = e(2),
        ...
        Q = function (t) {
          ...
          return (
            !(this === W && i(B, t) && !i(V, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, R) && this[R][t])) || n)
          );
        },
        Z = function (t, n) {
          ...
          return (
            ...
            (t.prototype.getLoginStatus = function () {
              return (
                ...
                !1 === this.status &&
                  ((0, u.removeLocalStorageValue)(this.accessTokenName), (0, c.expireCookie)(this.accessTokenName)),
                this.status
              );
            }),
